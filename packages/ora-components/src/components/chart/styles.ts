export const ChartStyles = {
    ...
    gridLine: 'stroke-on-surface-variant/10 stroke-1',
    ...
    tooltipGlass: 'absolute z-50 p-2 rounded-large glass-effect shadow-level-2 [overflow:clip] pointer-events-none text-body-small whitespace-nowrap transition-opacity duration-200',
