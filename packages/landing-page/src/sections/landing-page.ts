...
function createFooter(): HTMLElement {
    ...
    socialCol.innerHTML = `
        ...
        <div class="flex flex-col gap-px-12">
            <a href="https://github.com/tdq/ora-components" target="_blank" rel="noopener" class="flex items-center gap-px-12 text-body-medium text-on-surface-variant hover:text-primary transition-colors duration-200 group" style="opacity: 0.7;">
            ...
            <a href="https://www.npmjs.com/package/@tdq/ora-components" target="_blank" rel="noopener" class="flex items-center gap-px-12 text-body-medium text-on-surface-variant hover:text-primary transition-colors duration-200" style="opacity: 0.7;">
                <div class="w-8 h-8 rounded-medium flex items-center justify-center border" style="border-color: rgba(121,116,126,0.15); background: var(--md-sys-color-surface);">
            ...
            <a href="https://storybook.${window.location.hostname.replace(/^www\./, '')}" target="_blank" rel="noopener" class="flex items-center gap-px-12 text-body-medium text-on-surface-variant hover:text-primary transition-colors duration-200" style="opacity: 0.7;">
                <div class="w-8 h-8 rounded-medium flex items-center justify-center border" style="border-color: rgba(121,116,126,0.15); background: var(--md-sys-color-surface);">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
    ...
    bottomBar.innerHTML = `
        ...
        <p class="text-label-medium text-on-surface-variant flex items-center gap-px-8" style="opacity: 0.5;">
            ...
            &amp; <a href="https://rxjs.dev/" target="_blank" rel="noopener" style="-webkit-text-fill-color: inherit; text-decoration: none; opacity: 1;">RxJS</a>
        </p>
    `;
